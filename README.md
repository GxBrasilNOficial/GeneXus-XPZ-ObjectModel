...
- exemplos sanitizados servem para documentação pública, não como fonte final de materialização
...
- los ejemplos sanitizados sirven para documentación pública, no como fuente final de materialización
