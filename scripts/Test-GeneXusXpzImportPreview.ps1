...
function New-MsBuildProjectContent {
    ...
    $includeEscaped = Escape-Xml -Value $IncludeItems
    $excludeEscaped = Escape-Xml -Value $ExcludeItems
...
try {
    ...
    $projectContent = New-MsBuildProjectContent -ResolvedGeneXusDir $resolvedGeneXusDir -ResolvedKbPath $resolvedKbPath -ResolvedXpzPath $resolvedXpzPath -ResolvedUpdateFilePath $resolvedUpdateFilePath
